...
@Mojo(name = "rollup", defaultPhase = LifecyclePhase.GENERATE_RESOURCES, threadSafe = true)
public final class RollupMojo extends AbstractFrontendMojo {
     ...
     * Defaults to rollupfile.js in the {@link #workingDirectory}.
     */
    ...
    private boolean shouldExecute() {
        if (triggerfiles == null || triggerfiles.isEmpty()) {
            triggerfiles = Arrays.asList(new File(workingDirectory, "rollupfile.js"));
        }
